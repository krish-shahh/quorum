...
from tradingagents.execution.schemas import DiscoveredTicker, DiscoveryStatus
...
class OpportunityScanner:
    ...
    def __init__(self, universe: Optional[List[str]] = None):
        if universe is not None:
            ...
            from tradingagents.execution.ticker_utils import EQUITY_TICKERS
...
class CandidatesQueue:
    ...
    def __init__(self, path: Optional[str] = None):
        self._path = Path(path or os.path.join(_TRADINGAGENTS_HOME, "candidates.json"))
