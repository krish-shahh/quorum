...
_TRADINGAGENTS_HOME = Path(os.environ.get("TRADINGAGENTS_HOME", Path.home() / ".tradingagents"))
_CACHE_DIR = _TRADINGAGENTS_HOME / "sec_cache"
...
def get_sec_filings(ticker: str, filing_type: str = "all", limit: int = 5) -> str:
    ...
    try:
        set_identity("TradingAgents 2003kshah@gmail.com")
