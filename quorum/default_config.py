...
# their .env file.
_ENV_OVERRIDES = {
    "QUORUM_LLM_PROVIDER":         "llm_provider",
    "QUORUM_DEEP_THINK_LLM":       "deep_think_llm",
    "QUORUM_QUICK_THINK_LLM":      "quick_think_llm",
    "QUORUM_LLM_BACKEND_URL":      "backend_url",
    "QUORUM_OUTPUT_LANGUAGE":      "output_language",
    "QUORUM_MAX_DEBATE_ROUNDS":    "max_debate_rounds",
    "QUORUM_MAX_RISK_ROUNDS":      "max_risk_discuss_rounds",
    "QUORUM_BENCHMARK_TICKER":     "benchmark_ticker",
    # Execution layer overrides
    "QUORUM_EXECUTION_MODE":       "execution_mode",
    "QUORUM_PAPER_BALANCE":        "paper_starting_balance",
    "QUORUM_MAX_POSITION_PCT":     "max_position_pct",
    "QUORUM_MAX_SINGLE_TICKER_PCT": "max_single_ticker_pct",
    "QUORUM_MAX_OPEN_POSITIONS":   "max_open_positions",
    "QUORUM_MAX_DRAWDOWN_PCT":     "max_drawdown_pct",
    "QUORUM_PAPER_SLIPPAGE":       "paper_slippage_enabled",
    "QUORUM_PAPER_SPREAD_BPS":     "paper_spread_bps",
    "QUORUM_STOP_LOSS_ENABLED":    "stop_loss_enabled",
    "QUORUM_EXTENDED_HOURS":       "extended_hours",
    "QUORUM_SCHEDULED_TICKERS":    "scheduled_tickers",
    "QUORUM_SCHEDULE_TIME":        "schedule_time",
    "QUORUM_SCHEDULE_TIMEZONE":    "schedule_timezone",
    "QUORUM_INTRADAY_SNAPSHOTS":   "intraday_snapshots",
    # Email alerts
    "QUORUM_ALERTS_ENABLED":       "alerts_enabled",
    "QUORUM_ALERT_EMAIL_FROM":     "alert_email_from",
    "QUORUM_ALERT_EMAIL_TO":       "alert_email_to",
    "QUORUM_ALERT_SMTP_HOST":      "alert_smtp_host",
    "QUORUM_ALERT_SMTP_PORT":      "alert_smtp_port",
    "QUORUM_ALERT_SMTP_USER":      "alert_smtp_user",
    "QUORUM_ALERT_SMTP_PASSWORD":  "alert_smtp_password",
    # Webhook / advanced alerts
    "QUORUM_ALERT_SLACK_WEBHOOK":  "alert_slack_webhook",
    "QUORUM_ALERT_MIN_TRADE_VALUE": "alert_min_trade_value",
    # alert_on_signals is a list; env var is comma-separated
    # (e.g. QUORUM_ALERT_ON_SIGNALS=Buy,Sell)
    "QUORUM_ALERT_ON_SIGNALS":     "alert_on_signals",
    "QUORUM_ALERT_DAILY_SUMMARY":  "alert_daily_summary",
    # Discovery / autonomous scanning
    "QUORUM_DISCOVERY_ENABLED":    "discovery_enabled",
    "QUORUM_DISCOVERY_MODE":       "discovery_mode",
    "QUORUM_DISCOVERY_SCAN_INTERVAL": "discovery_scan_interval_hours",
    "QUORUM_DISCOVERY_MIN_SIGNAL": "discovery_min_signal_strength",
    "QUORUM_DISCOVERY_MAX_CANDIDATES": "discovery_max_candidates",
    # Wiki / knowledge base
    "QUORUM_WIKI_ENABLED":         "wiki_enabled",
    "QUORUM_WIKI_DIR":             "wiki_dir",
    # Data edge features
    "QUORUM_INSIDER_CLUSTERING":   "insider_clustering_enabled",
    "QUORUM_SECTOR_ROTATION":      "sector_rotation_enabled",
    "QUORUM_EARNINGS_AVOIDANCE":   "earnings_avoidance_enabled",
    "QUORUM_MACRO_EVENT_ADJ":      "macro_event_adjustment_enabled",
...
def _apply_env_overrides(config: dict) -> dict:
    """Apply QUORUM_* env vars to the config dict in-place."""
...
DEFAULT_CONFIG = _apply_profile(_apply_env_overrides({
    ...
    "memory_log_path": os.getenv("QUORUM_MEMORY_LOG_PATH", os.path.join(_QUORUM_HOME, "memory", "trading_memory.md")),
    ...
    # ------------------------------------------------------------------
    "wiki_enabled": True,
    "wiki_dir": os.path.join(_QUORUM_HOME, "wiki"),
    # ------------------------------------------------------------------
