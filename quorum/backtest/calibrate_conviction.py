...
Usage::
    ...
    python -m quorum.backtest.calibrate_conviction
    python -m quorum.backtest.calibrate_conviction --days 180
"""
...
_DB_PATH = os.path.join(
    os.environ.get("QUORUM_HOME", os.path.join(os.path.expanduser("~"), ".quorum")),
    "quorum.db",
)
