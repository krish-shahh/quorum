...
- `quorum/council/prompts/fundamental.md`
...
Agent(description="Fundamental Analyst: {TICKER}", model="haiku", prompt=<fundamental prompt with substitutions>)
...
3. If **changes detected**: run targeted analysis (Step 1.5 triage) ONLY for changed tickers
